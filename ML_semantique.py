...
def extract_data():
    ...
    for i in [9,10,12,15,18,19,24,26,27,30]:
        ...
        semantique="C:/Users/hcroc/OneDrive/Bureau/PAF_2023/data_semantique/"+str(i)
        data_sousdossier=[]
        
        for num_segment in range(len(os.listdir(semantique))): #on parcourt tous les segments du sous-dossier
            
            file_name=semantique+"/segment_"+str(num_segment)+".npy" #nom du segment dans notre dossier
    ...
    for j in range(0,10):
        for i in range(j,j+1):
            ...
            if cross_validation: 
                ...
                model = RandomForestClassifier(max_depth=30, min_samples_leaf=1, n_estimators=150)
